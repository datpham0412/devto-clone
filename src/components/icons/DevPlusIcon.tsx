...
export const DevPlusIcon: React.FC<{ className?: string }> = ({ className }) => {
  return (
    <svg
      version="1.0"
      ...
      height="24"
    >
      <g transform="translate(0.000000,102.000000) scale(0.100000,-0.100000)" fill="currentColor" stroke="none">
