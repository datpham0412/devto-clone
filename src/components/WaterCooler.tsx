    ...
    <section className="rounded-lg bg-white p-4 shadow-sm mb-4">
      <header className="mb-4">
        <h3 className="text-lg font-medium">
          <Link href="/t/watercooler" className="text-[#404040] hover:text-[#404040]/80 text-[20px] font-bold">
            #watercooler
          </Link>
        </h3>
      ...
      <div className="flex flex-col gap-4">
        {waterCoolerItems.map((item, index) => (
          <>
            ...
            >
              <span className="mb-2 pt-1 text-base text-gray-600 font-normal">{item.title}</span>
